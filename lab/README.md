...
Entorno **reproducible y aislado** para los casos del capítulo 6. El hardware de inferencia (`Proyecto-HW`) es un repositorio independiente; aquí se documenta la **capa lógica** (labs, CTFs, tools).
